...
async function main() {
  ...
  try {
    ...
    const menuBtn = page
      .locator(
        '.mobile-header button:first-child, .v-app-bar button:first-child, button:has(.mdi-menu)'
      )
      .first()
    ...
    const themeBtn = page
      .locator('.mobile-header button:last-child, .v-app-bar button:has(.mdi-weather)')
      .first()
