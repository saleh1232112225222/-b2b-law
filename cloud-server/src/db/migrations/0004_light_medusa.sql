...
--> statement-breakpoint
ALTER TABLE "clients" ADD COLUMN "direct_notes" text;--> statement-breakpoint
ALTER TABLE "companies" ADD COLUMN "is_deleted" boolean DEFAULT false;--> statement-breakpoint
...
ALTER TABLE "finances" ADD COLUMN "legal_engagement_id" uuid;--> statement-breakpoint
ALTER TABLE "finances" ADD COLUMN "paid_amount" numeric(12, 2) DEFAULT '0';--> statement-breakpoint
ALTER TABLE "finances" ADD COLUMN "remaining_amount" numeric(12, 2) DEFAULT '0';--> statement-breakpoint
ALTER TABLE "finances" ADD COLUMN "payment_method" text;--> statement-breakpoint
ALTER TABLE "finances" ADD COLUMN "status" text DEFAULT 'pending';--> statement-breakpoint
ALTER TABLE "subscriptions" ADD COLUMN "suspended_at" timestamp with time zone;--> statement-breakpoint
ALTER TABLE "subscriptions" ADD COLUMN "suspend_reason" text;--> statement-breakpoint
...
ALTER TABLE "time_logs" ADD CONSTRAINT "time_logs_case_id_cases_id_fk" FOREIGN KEY ("case_id") REFERENCES "public"."cases"("id") ON DELETE set null ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "time_logs" ADD CONSTRAINT "time_logs_task_id_tasks_v2_id_fk" FOREIGN KEY ("task_id") REFERENCES "public"."tasks_v2"("id") ON DELETE set null ON UPDATE no action;