...
;(async () => {
  ...
  const addClientBtn = page
    .locator('button:has-text("إضافة موكل"), button:has-text("جديد"), button:has-text("إضافة")')
    .first()
  ...
  const addCaseBtn = page
    .locator('button:has-text("إضافة قضية"), button:has-text("جديد"), button:has-text("إضافة")')
    .first()
  ...
  await page.waitForTimeout(2000)
  const addSessionBtn = page
    .locator('button:has-text("إضافة جلسة"), button:has-text("جديد"), button:has-text("إضافة")')
    .first()
