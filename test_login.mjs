...
const lsAfter = await page.evaluate(() => JSON.stringify(Object.fromEntries(Object.entries(localStorage).filter(([k]) => k.startsWith('web_') || k.startsWith('b2b_') || k.startsWith('test')))));
