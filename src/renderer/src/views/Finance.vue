  ...
  <v-container fluid class="pa-6 pb-12 rtl">
    ...
    <v-row dense class="mb-8 align-center">
      ...
      <v-col cols="auto">
        ...
        <v-btn
          ...
          variant="outlined"
          size="large"
          class="font-weight-black rounded-lg px-8 premium-lift h-100 ms-3"
    ...
    <v-row class="mb-8" dense>
      <v-col v-for="(stat, key) in statCards" :key="key" cols="12" md="4">
        <v-card
          elevation="0"
          class="glass-card premium-hover pa-6 position-relative overflow-hidden"
        >
          <v-skeleton-loader
            v-if="loading || !stats"
            ...
            >
              ...
              <template #[`item.type`]="{ item }">
                ...
                >
                  <LucideIcon
                    :name="
                      (item as Transaction).type === 'income' ? 'arrow-down-left' : 'arrow-up-right'
                    "
                    :size="12"
                    class="me-1"
                  />
    ...
    <v-dialog v-model="showDialog" width="90%" max-width="850" persistent scrollable>
      <v-card v-if="showDialog" class="rounded-xl elevation-24 overflow-hidden modal-card">
        <v-toolbar color="white" class="px-8 border-b" height="72">
          ...
          >
          <v-spacer></v-spacer>
          <v-btn icon variant="text" size="small" class="rounded-lg" @click="closeDialog">
          ...
          <v-form ref="formRef" v-model="formValid">
            <v-row>
              ...
              <v-col cols="12" class="mb-6">
                <div class="glass-panel-light pa-1 rounded-xl border overflow-hidden">
                  <v-btn-toggle
                    ...
                    mandatory
                    color="gold"
                    class="w-100 rounded-lg overflow-hidden bg-white border-gold-alpha"
                    variant="flat"
                    density="comfortable"
                  >
                    <v-btn
                      value="income"
                      class="flex-grow-1 h-48 font-weight-black text-gold"
              ...
              <v-col v-if="editItem.type === 'expense'" cols="12">
                <v-label class="mb-2 font-weight-black text-pure-black opacity-80"
                  >وجهة صرف المبلغ*</v-label
                >
                <v-select
              ...
              <v-col cols="12">
                <v-label class="mb-2 font-weight-black text-pure-black opacity-80"
                  >وصف العملية / البيان المحاسبي</v-label
                >
                <v-textarea
        ...
        <v-card-actions class="pa-8 modal-footer-solid">
          <v-btn
            ...
            variant="outlined"
            size="large"
            class="px-12 font-weight-black btn-unified action-btn-unified h-56"
            @click="closeDialog"
            >إلغاء</v-btn
          >
          <v-spacer></v-spacer>
    ...
    <v-dialog v-model="showDeleteDialog" width="90%" max-width="500" persistent>
      <v-card class="rounded-xl elevation-24 overflow-hidden modal-card border-error-alpha">
        <v-toolbar color="white" class="px-8 border-b" height="72">
        ...
        <v-card-actions class="pa-8 modal-footer-solid">
          <v-btn
            ...
            variant="outlined"
            size="large"
            class="px-8 font-weight-black btn-unified h-56"
            @click="showDeleteDialog = false"
            >تراجع</v-btn
          >
          <v-spacer></v-spacer>
          <v-btn
            ...
            variant="flat"
            size="large"
            class="px-8 font-weight-black rounded-lg premium-lift h-56"
            :loading="deleting"
            @click="handleDelete"
          >
            تأكيد الحذف النهائي
