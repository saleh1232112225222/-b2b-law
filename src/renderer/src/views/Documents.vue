  ...
  <v-container fluid class="pa-6 rtl">
    ...
    <v-card elevation="0" class="glass-card mb-8 pa-6 border-gold-alpha">
      <v-row dense align="center">
        ...
        <v-spacer />
        <v-col cols="auto">
          <div class="d-flex align-center px-4 py-2 rounded-lg glass-panel-light border-gold-alpha">
    ...
    <v-row v-else class="ma-0 ga-0">
      ...
      >
        <v-card
          elevation="0"
          class="glass-card premium-lift pa-5 border-gold-alpha position-relative h-100"
        ...
        >
          ...
          >
            ...
            <span class="text-truncate">{{ valWithDefault(doc.context_label, 'مكتبة عامة') }}</span>
          </v-chip>
      ...
      <v-card class="glass-card overflow-hidden">
        ...
        <v-card-actions class="pa-8 glass-panel border-t border-gold-alpha">
          ...
          <v-btn
            color="primary"
            variant="flat"
            class="px-10 rounded-lg font-weight-black h-48 premium-lift"
