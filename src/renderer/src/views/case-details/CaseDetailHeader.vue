    ...
    <v-row align="center">
      <v-col>
        <div class="d-flex align-center mb-2">
          <v-chip color="accent" variant="flat" class="me-3 font-weight-black text-primary-dark">{{
          ...
          <v-chip
            ...
            >{{ caseItem.priority }}</v-chip
          >
        </div>
        <div class="text-h6 font-weight-black text-visible-high text-wrap-dynamic">
