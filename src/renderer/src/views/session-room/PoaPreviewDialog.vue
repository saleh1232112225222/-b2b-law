        ...
        <v-row dense>
          <v-col cols="12" md="6">
            <div class="detail-row mb-6">
              <span class="text-caption text-grey-darken-1 mb-1 d-block font-weight-black"
                >الرقم المرجعي الرسمي</span
              >
            ...
            <div class="detail-row mb-6">
              ...
              <div class="d-flex align-center">
                ...
                <v-chip
                  ...
                  >{{ convertHijri(data.date) }} هـ</v-chip
                >
              </div>
            </div>
          </v-col>
            ...
            <div class="detail-row mb-6">
              ...
              <div class="d-flex align-center">
                ...
                <v-chip
                  ...
                  variant="tonal"
                  class="ms-3 font-weight-black"
                  >{{ convertHijri(data.expiry_date) }} هـ</v-chip
                >
              </div>
            </div>
          </v-col>
          ...
          <v-col cols="12">
            <div class="detail-row mb-2">
              <span class="text-caption text-grey-darken-1 mb-2 d-block font-weight-black"
                >نطاق الوكالة / الصلاحيات الممنوحة</span
              >
              <div class="bg-white pa-4 rounded-lg text-black leading-relaxed shadow-sm border">
                {{ data?.notes || 'لا توجد ملاحظات مسجلة لنطاق هذه الوكالة' }}
              </div>
            </div>
          </v-col>
        </v-row>
