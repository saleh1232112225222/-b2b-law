...
export const POSTPONEMENT_REASONS = [
  'لتبادل المذكرات والردود',
  'لورود تقرير الخبير',
  'لتبليغ / حضور الخصم',
  'لتقديم المستندات والبينات',
  'لإمهال المدعي / المدعى عليه',
  'للمداولة والتدقيق',
  'سبب إجرائي آخر'
]

export const POSTPONEMENT_ACTIONS = [
  'إيداع مذكرة جوابية',
  'تقديم مستندات وبينات',
  'متابعة أعمال الخبرة',
  'حضور الجلسة والمرافعة',
  'تبليغ الخصم',
  'أخرى'
]

export const POSTPONEMENT_ASSIGNED_PARTIES = [
  'مكتبنا (فريق المرافعة)',
  'الموكل',
  'الخصم',
  'المحكمة',
  'الخبير'
